 ...
 *
 *  The computer program(s) is the proprietary information of Cordys Systems B.V.,       and
 * provided under the relevant Agreement between yourself and Cordys Systems B.V.       containing
 * restrictions on use and disclosure, and are also protected by copyright,       patent, and other
 * intellectual and industrial property laws. No part of this program       may be used/copied
 * without the prior written consent of Cordys Systems B.V.
 *
 *  Project                : JMS Connector       File Name        : Destination.java Date       :
 * Jan 23, 2006 Author                : awisse
 */
